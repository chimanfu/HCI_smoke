...
try{
	...
	println('ERROR: Unable to find sanity check link: ' + e.getMessage())
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Sanity Check/p_OK now running sanity checks'), 60)

WebUI.click(findTestObject('Object Repository/Page_Sanity Check/p_OK now running sanity checks'))
WebUI.waitForElementVisible(findTestObject('Page_Sanity Check/p_Sanity check completed'), 120)
