...
String verifiedRecord="//*[@id='cfgr_Verifications_row_1935140_collapsed_display_area_content_title']/span"
...
waifForElement("id=cf_verification_traceability_1935140",60)
WebUI.delay(1)
selenium.click("id=cf_verification_traceability_1935140")
selenium.select("id=cf_verification_traceability_1935140", "label=DMM")
waifForElement("id=cf_dmm_number_1935140",10)
selenium.click("id=cf_dmm_number_1935140")
selenium.waitForPageToLoad("30000")
selenium.type("id=cf_dmm_number_1935140", "Transmission")
selenium.waitForPageToLoad("30000")
WebUI.delay(2)
s.type(Key.ENTER)
selenium.waitForPageToLoad("30000")
...
selenium.click("id=cf_verification_traceability_1935140")
selenium.select("id=cf_verification_traceability_1935140", "label=DVO")
waifForElement("id=cf_dvo_number_1935140",10)
selenium.click("id=cf_dvo_number_1935140")
selenium.type("id=cf_dvo_number_1935140", "Transmission")
WebUI.delay(2)
s.type(Key.ENTER)
selenium.waitForPageToLoad("30000")
selenium.click("id=daggr_title_search")
...
selenium.click("id=cf_verification_traceability_1935140")
selenium.select("id=cf_verification_traceability_1935140", "label=LCC")
waifForElement("id=cf_lcc_id_1935140",10)
selenium.click("id=cf_lcc_id_1935140")
selenium.type("id=cf_lcc_id_1935140", "Transmission")
WebUI.delay(2)
s.type(Key.ENTER)
selenium.waitForPageToLoad("30000")
selenium.click("id=daggr_title_search")
...
selenium.click("id=cf_verification_traceability_1935140")
selenium.select("id=cf_verification_traceability_1935140", "label=OMRS")
waifForElement("id=cf_omrs_number_1935140",10)
selenium.click("id=cf_omrs_number_1935140")
selenium.type("id=cf_omrs_number_1935140", "Transmission")
WebUI.delay(2)
s.type(Key.ENTER)
selenium.waitForPageToLoad("30000")
//selenium.click("id=daggr_title_search")
