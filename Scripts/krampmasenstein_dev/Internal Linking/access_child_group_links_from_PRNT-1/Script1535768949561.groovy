...
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/span_CHLD-1 GROUP-1_CHLD-1'),10)
WebUI.delay(1)
WebUI.click(findTestObject('Page_G2G_linking_record/span_CHLD-1 GROUP-1_CHLD-1'))
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/div_Child Linking Group'),15)

select_PRNT_1_GROUP_PRNT_1()
WebUI.waitForElementClickable(findTestObject('Page_G2G_linking_record/span_CHLD-2 GROUP-1_CHLD-2'),10)
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/span_CHLD-2 GROUP-1_CHLD-2'),10)
WebUI.delay(1)
WebUI.click(findTestObject('Page_G2G_linking_record/span_CHLD-2 GROUP-1_CHLD-2'))
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/div_Child Linking Group'),15)

select_PRNT_1_GROUP_PRNT_1()
WebUI.waitForElementClickable(findTestObject('Page_G2G_linking_record/span_CHLD-3 GROUP-1_CHLD-3'),10)
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/span_CHLD-3 GROUP-1_CHLD-3'),10)
WebUI.delay(1)
WebUI.click(findTestObject('Page_G2G_linking_record/span_CHLD-3 GROUP-1_CHLD-3'))
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/div_Child Linking Group'),15)

select_PRNT_1_GROUP_PRNT_1()
WebUI.waitForElementClickable(findTestObject('Page_G2G_linking_record/span_CHLD-4 GROUP-1_CHLD-4'),10)
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/span_CHLD-4 GROUP-1_CHLD-4'),10)
WebUI.delay(1)
WebUI.click(findTestObject('Page_G2G_linking_record/span_CHLD-4 GROUP-1_CHLD-4'))
WebUI.waitForElementVisible(findTestObject('Page_G2G_linking_record/div_Child Linking Group'),15)
