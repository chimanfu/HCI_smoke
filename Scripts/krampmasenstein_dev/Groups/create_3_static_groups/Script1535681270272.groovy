...
def create_3_groups(){
	...
	WebUI.setText(findTestObject('Page_--- 7081 test_automation_recor/input_cf_groups_static_text_NEW_ROW_1'), 'Group1')
	WebUI.click(findTestObject('Page_--- 7081 test_automation_recor/button_Add STATIC-2'))
	WebUI.setText(findTestObject('Page_--- 7081 test_automation_recor/input_cf_groups_static_text_NEW_ROW_2'), 'Group2')
	WebUI.click(findTestObject('Page_--- 7081 test_automation_recor/button_Add STATIC-3'))
	WebUI.setText(findTestObject('Page_--- 7081 test_automation_recor/input_cf_groups_static_text_NEW_ROW_3'), 'Group3')
