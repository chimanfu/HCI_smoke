if (CustomKeywords.'ip_permissions.utils.addGlobalVariable'('testrun_status','RUN').equals('SKIP')) return
...
println 'waifForElement:'+verifiedRecord
...
WebUI.delay(3)
//s.type(Key.ENTER)
selenium.typeKeys("id=cf_lcc_id_"+verification_id, Keys.chord(Keys.ENTER))
