...
WebUI.setText(findTestObject('Object Repository/Page_ARC JET/input_keywords'), 'AHF 307')
...
//WebUI.click(findTestObject('Object Repository/Page_ARC JET/td_AHF 306 Pre-test IR Camera'))
