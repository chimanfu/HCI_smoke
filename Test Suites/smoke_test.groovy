...
def setUp() {
	...
	Runtime.getRuntime().exec(cmd)
	println('killed all processes of Chrome and chromedriver')
}
...
def setupTestCase() {
	...
	if (WebUI.waitForElementPresent(findTestObject('Page_Access Launchpad/input_SCLOGIN'),6,FailureHandling.OPTIONAL)){
